...
export default async function PostDetails({
        ...
        const postIdNumber=(await params).postId
        const post_res=await fetch(`https://jsonplaceholder.typicode.com/posts/${postIdNumber}`)
        if(!post_res.ok){
            notFound()
        }
        const post=await fetch(`https://jsonplaceholder.typicode.com/posts/${postIdNumber}`).then((res)=>res.json())
        const userId=post.userId 
        const user=await fetch(`https://jsonplaceholder.typicode.com/users/${userId}`).then((res)=>res.json())
        const comments=await fetch(`https://jsonplaceholder.typicode.com/posts/${postIdNumber}/comments`).then((res)=>res.json())
